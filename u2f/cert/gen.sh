...
openssl req -new -sha256 -key attestation_key.pem -out csr.csr -subj "/"
openssl req -x509 -sha256 -days 36500 -key attestation_key.pem -in csr.csr -out attestation.pem
